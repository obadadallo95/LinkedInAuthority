...
let code = fs.readFileSync('src/components/RepoDetails.tsx', 'utf-8');

// I will extract the parts and reconstruct the return block.
const beforeReturn = code.split('return (')[0];
const afterReturn = code.split('return (')[1];
...
const finalCode = beforeReturn + "return (" + newReturn;

fs.writeFileSync('src/components/RepoDetails.tsx', finalCode);
console.log("Done");
