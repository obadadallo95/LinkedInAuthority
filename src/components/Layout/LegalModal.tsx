...
export const LegalModal: React.FC<LegalModalProps> = ({ isOpen, onClose, lang, initialTab = 'privacy' }) => {
  ...
  const content = {
    ar: {
      ...
      faq1A: "قد تُحفظ مقتطفات محدودة من الملفات المختارة ومراجع الأدلة ضمن snapshot للتحليل؛ لا نعد باحتفاظ صفري في هذه النسخة التجريبية.",
      faq2Q: "هل يمكنني حذف بياناتي؟",
      faq2A: "يوفر الإصدار التجريبي مسار حذف موثقاً يحذف بيانات Firebase وحساب المصادقة بشكل تكراري. يلزم التحقق من المشروع المنشور ومراجعة الاحتفاظ قبل تقديم ادعاء تنظيمي بالمحو الكامل.",
      ...
      privacyText1: "هذه نسخة تجريبية نشطة. تُرسل بيانات اعتماد GitHub إلى الخادم مرة واحدة عند الربط وتُحفظ مشفّرة في سجل خاص لا يقرأه العميل. قد تُحفظ بيانات وصف المستودع وملخصات التحليل والمسودات لتشغيل المنتج.",
      privacyText2: "لا ينبغي اعتبار النسخة الحالية نظام احتفاظ صفري أو ضمان حذف شامل. لا تُحفظ أسرار Gemini أو GitHub في telemetry، وتبقى مراجعة المسودة ومسؤولية نشرها على المستخدم.",
    ...
    en: {
      ...
      faq1A: "Bounded snippets from selected evidence files and their references may be stored in repository snapshots; this beta does not promise zero retention.",
      faq2Q: "Can I delete my data?",
      faq2A: "The beta provides an authenticated account-deletion flow that recursively removes the user's Firebase data and Auth account. Deployed-project verification and retention review are still required before making a regulatory erasure claim.",
      ...
      privacyText1: "This is an active beta. GitHub credentials are sent once to the server when connected and stored encrypted in an Admin-only private record. Repository metadata, analysis summaries, and drafts may be persisted to operate the product.",
      privacyText2: "Repository-derived context and drafts may be persisted by the current application. This beta does not claim complete data-retention or erasure guarantees.",
    ...
    de: {
      ...
      faq1A: "Begrenzte Ausschnitte ausgewählter Evidenzdateien und ihre Referenzen können in Repository-Snapshots gespeichert werden; diese Beta verspricht keine Null-Aufbewahrung.",
      faq2Q: "Kann ich meine Daten löschen?",
      faq2A: "Die Beta bietet einen rekursiven Löschvorgang für Firebase-Daten und das Auth-Konto; eine Prüfung der bereitgestellten Umgebung und der Aufbewahrung ist vor regulatorischen Aussagen erforderlich.",
      ...
      privacyText1: "Dies ist eine aktive Beta. GitHub-Zugangsdaten werden beim Verbinden einmalig an den Server gesendet und verschlüsselt in einem nur serverseitig lesbaren Datensatz gespeichert. Repository-Metadaten, Analysen und Entwürfe können zur Produktfunktion gespeichert werden.",
      privacyText2: "Repository-abgeleiteter Kontext und Entwürfe können von der aktuellen Anwendung gespeichert werden. Diese Beta beansprucht keine vollständige Aufbewahrungs- oder Löschgarantie.",
                      ...
                      <div className="bg-gradient-to-tr from-slate-950 to-slate-900 border border-purple-500/20 rounded-3xl p-6 relative overflow-hidden shadow-xl">
                        ...
                        <p className={`text-xs text-slate-400 mt-4 leading-normal ${isAr ? 'text-right' : 'text-left'}`}>
                          {isAr 
                            ...
                            : "LinkedIn Authority is an active beta that turns repository context into editable technical drafts for review and manual sharing."
                          }
                        </p>
                      </div>
