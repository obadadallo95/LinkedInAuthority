...
export const SettingsPanel = ({ 
  ...
  const connectGithub = async () => {
    ...
    try {
      ...
      const githubAlreadyLinked = auth.currentUser.providerData.some(({ providerId }) => providerId === 'github.com');
      if (githubAlreadyLinked) {
        ...
        try {
          ...
          // If GitHub is already attached to another Firebase identity, use
