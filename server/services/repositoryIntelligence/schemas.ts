...
export const generateSchema: Schema = {
  ...
  properties: {
    ...
    suggestedComment: { type: Type.STRING, description: "An optional manual follow-up note containing only verified repository or project links; never engagement bait." },
    usedEvidenceIds: { 
      type: Type.ARRAY, 
